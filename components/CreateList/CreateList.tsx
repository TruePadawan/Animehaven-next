...
const CreateList = (props: CreateListProps) => {
  ...
  const updateVisibility = (e: ChangeEvent<HTMLInputElement>, value: string) =>
    setVisibility(value);
    ...
    try {
      ...
      if (props.defaultValues?.id === undefined) {
        return triggerAlert("Failed to update list", {
          ...
          error: {
            message:
              "Could not get the Id of the anime list, try reloading the page",
          },
        });
      }
          ...
          <Box className={styles.component}>
            ...
            <Box className={styles.addItems}>
              ...
              <div className="d-flex flex-column">
                ...
                />
                {isSearchOngoing && <Loading sx={{ marginTop: "4px" }} />}
                {!isSearchOngoing && (
